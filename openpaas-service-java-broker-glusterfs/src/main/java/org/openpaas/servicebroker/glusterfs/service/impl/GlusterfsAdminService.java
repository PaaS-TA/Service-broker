...
public class GlusterfsAdminService {
	 ...
	 */
	public void save(ServiceInstance serviceInstance) throws GlusterfsServiceException{
		try{
	 ...
	 * @throws GlusterfsServiceException
	 */
	public void deleteDatabase(ServiceInstance serviceInstance) throws GlusterfsServiceException{
		try{
	 ...
	 * @throws GlusterfsServiceException
	 */
	public void createUser(String database, String userId, String password) throws GlusterfsServiceException{
		try{
			System.out.println("GlusterfsAdminService.createUser");
	 ...
	 * @throws GlusterfsServiceException
	 */
	public void deleteUser(String database, String bindingId) throws GlusterfsServiceException{
		try{
