...
/**
 * Mysql impl to bind services.  Binding a service does the following:
 * creates a new user in the database (password is Ramdom String value),
 * saves the ServiceInstanceBinding info to the Mysql repository.
 *  
...
public class MysqlServiceInstanceBindingService implements ServiceInstanceBindingService {
	...
	public ServiceInstanceBinding createServiceInstanceBinding(
		...
		*/
		...
		binding = new ServiceInstanceBinding(request.getBindingId(), instance.getServiceInstanceId(), credentials, mysqlAdminService.getDashboardUrl(database), request.getAppGuid());
