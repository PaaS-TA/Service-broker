...
/**
 * Pinpoint instance를 조작하기위한 유틸리티 클래스.
 */
@Service
public class PinpointAdminService {
    ...
    public ServiceInstanceBinding createServiceInstanceBindingByRequest(CreateServiceInstanceBindingRequest request) throws PinpointServiceException, ServiceInstanceBindingExistsException {
        ...
        if (null == map || null == map.get("application_name")) throw new PinpointServiceException("Must be support cf -c {\"application_name\": \"parameter\"}");
