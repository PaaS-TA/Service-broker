...
@Service
public class NaverAPIServiceInstanceBindingService implements ServiceInstanceBindingService{
	
	private static final Logger logger = LoggerFactory.getLogger(NaverAPIServiceInstanceBindingService.class);
