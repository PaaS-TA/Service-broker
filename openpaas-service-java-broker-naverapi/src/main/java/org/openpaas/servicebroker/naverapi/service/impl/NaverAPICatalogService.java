...
public class NaverAPICatalogService implements CatalogService {

	private static final Logger logger = LoggerFactory.getLogger(NaverAPICatalogService.class);
	...
	@Autowired
	public NaverAPICatalogService(Catalog catalog) {
